...
import { getMonthFromCardDate, getYearFromCardDate, formatCVC } from '../utils/card'
...
export const mustBeCardDate = expirationDate => {
    ...
    return PaymentLib.fns.validateCardExpiry(month, year) ?
        undefined : "Expiry date is not valid"
}
...
export const mustBeEuVat = (vatNumber = '') => {
    ...
    return reVat.test(formatedVatNumber) ? undefined : "EU VAT number is not correct"
}
