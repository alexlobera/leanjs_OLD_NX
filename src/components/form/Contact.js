  ...
  render() {
    ...
    return (
      <React.Fragment>
        ...
        <P>The best way to contact us is by emailing us at <Link to="mailto:hello@reactjsacademy.com">hello@reactjs.academy</Link>. </P>
        <P>Otherwise, you can contact us socially on <Link to="https://twitter.com/reactjsacademy">Twitter</Link>, <Link to="https://www.instagram.com/reactjsacademy/">Instagram</Link> and <Link to="https://www.facebook.com/reactjsacademy/">Facebook</Link> or visit our <Link to="/about-us">About Us page</Link> and directly contact one of our coaches. </P>
