...
export const trainings = [
  {
    ...
    priceGoesUpOn: new Date('April 30, 2019'),
    currency: 'gbp',
  ...
  },
  {
    ...
    price: 1800,
    discountPrice: 1450,
    priceGoesUpOn: new Date('March 29, 2019'),
    currency: 'gbp',
    image: LONDON_LOCATION,
  ...
  },
  {
    ...
    price: 415,
    discountPrice: 165.835,
    // priceGoesUpOn: new Date('Mar 15, 2019'),
    currency: 'eur',
  ...
  // },
  {
    ...
    country: 'Holland',
    location: 'Willemsparkweg 92 H, 1071 HM Amsterdam',
