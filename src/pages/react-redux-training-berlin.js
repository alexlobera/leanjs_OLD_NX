  ...
  <React.Fragment>
    <Breadcrumb
      path={[
        ...
        { to: '/react-redux-training-berlin', label: 'Berlin' },
      ]}
    />
    <Header
      titleLines={['React Redux GraphQL Bootcamp', 'Training in Berlin']}
      subtitle="Take your dev career to the next level in Berlin - Germany - by mastering<br />React, Redux, and GraphQL - in just 1 week!"
