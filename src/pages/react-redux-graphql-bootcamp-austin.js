  ...
  <React.Fragment>
    <Breadcrumb
      path={[
        ...
        { to: '/react-redux-graphql-bootcamp-austin', label: 'Austin' },
      ]}
    />
    <Header
      titleLines={['React Redux GraphQL Bootcamp', 'Training in Austin']}
      subtitle="Take your dev career to the next level in Austin -Texas- by mastering<br />React, Redux, and GraphQL - in just 1 week!"
