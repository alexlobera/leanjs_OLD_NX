                  ...
                  <Col lg={10} lgOffset={1}>
                    <Row>
                      <Col md={5}>
                        ...
                        <Ul>
                          <Li>
                            Everyone is required to adhere to the code of
                            conduct - <strong>everyone</strong>.
                          </Li>
                          <Li>
                      ...
                      <Col md={6} mdOffset={1}>
                        <H2>Summary</H2>
                        <P>
                          Every person at our trainings will be required to
                          agree with this code of conduct and organisers will
                          enforce this code throughout any event run by React
                          GraphQL Academy.
                        </P>
                        <P>
                          All participants are expected to cooperate with us to
                          help guarentee a safe environment for everybody.
                        </P>
                        <P>
                          Our trainings are dedicated to providing a
                          harassment-free training experience for all who
                        ...
                        <P>
                          ...
                          participants. Sexual imagery and language is not
                          appropriate at any of our events, including formal
                          trainings, talks/meetups, workshops, or parties. This
                          is also applicable through social media such as
              ...
              <Row>
                <Col md={5} mdOffset={1}>
                  ...
                  <P>
                    ...
                    Additionally, sponsors and coaches should not use sexualised
                  ...
                  <P>
                    ...
                    member of React GraphQL Academy staff immediately. Our
                    coaches and representatives will identify themselves to you
                    at the start of any event and may also be identified via
                    branded clothing.
                  </P>
                  <P>
                    React GraphQL Academy staff will be happy to help
                    participants contact local law enforcement, source escorts,
                    or otherwise assist those experiencing harassment to feel
                    safe for the duration of the training event. We value your
                    attendance immensly and want you to have the best experience
                    possible.
                  </P>
                  <P>
                    We expect participants to follow these rules at our
                    trainings and training-related social events.
                  </P>
                </Col>
                <Col md={5} mdOffset={1}>
