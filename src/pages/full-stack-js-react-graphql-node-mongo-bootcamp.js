              ...
              <Card bg="dark">
                <Row>
                  ...
                  <Col xs={12} md={6} lg={5} lgOffset={1}>
                    <H2>
                      A JavaScript stack to build production-ready GraphQL APIs
                    </H2>
                    <P>
                      Build modern web applications using JavaScript and{' '}
                      <strong>GraphQL</strong> as the cornerstone to speed up
                      the development and performance of your applications. With
                      GraphQL you'll have a query language that runs on the
                      front-end and also on the back-end.
                    </P>
                    ...
                    <Ul>
                      ...
                      <Li>
                        ...
                        <Ul>
                          <Li>
                            Google Cloud Functions or Amazon Lambda Functions
                      ...
                      <Li>
                        ...
                        <Ul>
                          ...
                          <Li>Start coding</Li>
                          <Li>
                            Practice extreme programming and get support from
