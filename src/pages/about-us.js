          ...
          <Grid>
            <Row>
              ...
              <Col md={4} mdOffset={1} smOrder={1}>
                ...
                <Ul inline>
                  <Li>
                    <SocialLink to="https://github.com/alexlbr">
                      GitHub
                    </SocialLink>
                  </Li>
                  <Li>|</Li>
          ...
          <Grid>
            <Row>
              <Col md={4} mdOffset={1}>
                ...
                <Ul inline>
                  <Li>
                    <SocialLink to="https://github.com/ric9176">
                      GitHub
                    </SocialLink>
                  </Li>
                  <Li>|</Li>
                ...
                <Blockquote bg="primary" triangle="right">
                  Collaboratively working with developers to help them
                  understand concepts such as the functional programming
                  paradigm helps them take their skills to the next level - and
                  I learn a lot too!
                </Blockquote>
              </Col>
              <Col md={5} mdOffset={1}>
          ...
          <Grid>
            <Row>
              ...
              <Col md={4} mdOffset={1} smOrder={1}>
                ...
                <Ul inline>
                  <Li>
                    <SocialLink to="https://github.com/horacioh">
                      GitHub
                    </SocialLink>
                  </Li>
                  <Li>|</Li>
                  <Li>
                    <SocialLink to="https://medium.com/@hhg2288">
                      Medium
                    </SocialLink>
                  </Li>
                  <Li>|</Li>
          ...
          <Grid>
            <Row>
              <Col md={4} mdOffset={1}>
                ...
                <Blockquote bg="primary" triangle="right">
                  Everyone can learn how to program, and I enjoy supporting
                  others to learn and expand their skill set. Programming is
            ...
            <Row>
              <Col md={4} mdOffset={1}>
                ...
                <CoachTitle>
                  ...
                  <Link to="https://switchbay.com">City of Amsterdam</Link>, CTO
                  at <Link to="https://data.amsterdam.nl">SwitchBay</Link>
                </CoachTitle>
                <Ul inline>
                  <Li>
                    <SocialLink to="https://github.com/royderks">
                      GitHub
                    </SocialLink>
                  </Li>
                  <Li>|</Li>
          ...
          <Grid>
            <Row>
              ...
              <Col md={4} mdOffset={1} smOrder={1}>
                ...
                <Ul inline>
                  <Li>
                    <SocialLink to="https://github.com/flexbox">
                      GitHub
                    </SocialLink>
                  </Li>
                  <Li>|</Li>
                  <Li>
                    <SocialLink to="https://medium.com/@flexbox">
                      Medium
                    </SocialLink>
                  </Li>
                  <Li>|</Li>
                ...
                <Ul>
                  ...
                  <Li>
                    Organizer of the{' '}
                    <Link to="https://www.meetup.com/FranceJS/">
                      ChtiJS Meetup
                    </Link>{' '}
                    in France.
                  </Li>
          ...
          <Grid>
            <Row>
              <Col md={4} mdOffset={1}>
                ...
                <Blockquote bg="primary" triangle="right">
                  While teaching, the technology itself is not life-changing.
            ...
            <Row>
              ...
              <Col md={6} mdOffset={1} smOrder={1}>
                ...
                <P>
                  ...
                  continuously strive improve their teaching skills and training
                  material
                </P>
                <Ul>
                  <Li>
                    We improve the material and training resources
                    collaboratively to build the most complete, progressive, and
                    and up-to-date curriculum possible.
                  </Li>
                  <Li>
          ...
          <Grid>
            <Row>
              ...
              <Col md={5} mdOffset={1}>
                ...
                <P>
                  Coaches explain why we use a given stack and which problem(s)
                  it solves, and we should also explain alternative choices.
                  This way, trainees can make their own informed decisions about
                  what stack to use.
                </P>
                ...
                <P>
                  ...
                  and we explain the rationale behind our recommendations, then
                  trainees choose. We should try to balance the amount of
                  freedom.
                </P>
                <H3>Coaches are professional developers</H3>
                <P>
                  Bring your experience to the classroom. We try to explain
                  things in the classroom using real-world examples we’ve worked
                  on. Expressions like “in my experience” are very helpful.
                </P>
                <H3>Coaches are honest and humble</H3>
                <P>
                  Coaches don’t have to know everything. It’s better to say “I
                  don’t have any experience on that”, than trying to pretend you
                  know. We also learn from students, and students appreciate
                  when coaches say things like “thanks for sharing, I didn’t
                  know”.
                </P>
                ...
                <P>
                  ...
                  Sometimes students want a simple answer: “what should I do, A
                  or B?”. The answer in many cases is “it depends”. Our job is
                  to make sure we understand trainees’ problems, and they
                  understand the pros & cons of each approach we might recommend
              ...
              <Col md={5} mdOffset={1}>
                ...
                <P>
                  ...
                  have initiative, and collaborate for the common good of the
                  group.
                </P>
                ...
                <P>
                  ...
                  being willing to help. We can learn from anyone, everyone has
                  something to teach.
                </P>
                <H3>We respect each other</H3>
                <P>
                  Treat people as you would like them to treat you. If you
                  mentor another coach, you expect the other coach to appreciate
                  and get the most of your time and effort and to replicate at
                  least the same amount of effort. We don’t mentor another coach
                  over and over again if we don’t see enough effort and
                  dedication on the other end. If someone mentors you, you
                  should also mentor.
                </P>
                ...
                <P>
                  ...
                  right, and to learn from our mistakes so we do our best to not
                  make them again.
                </P>
                ...
                <P>
                  ...
                  with us as coaches will be proactive people that want to help
                  others.
                </P>
              </Col>
            </Row>
