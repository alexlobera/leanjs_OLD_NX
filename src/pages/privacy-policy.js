...
const PrivacyPolicy = ({ data, trainings }) => {
  const posts = getRandom(
    getPostsFromNodes({
  ...
  return (
    <React.Fragment>
        ...
        <Row>
          <Col md={7}>
            ...
            <P>
              ...
              Confirmation of event/training ticket purchase Reminder of
            ...
            <P>
              ...
              share your personal details with third parties without your
              consent.
            </P>
            ...
            <P>
              For example, we hold many training events at third party venues
              and to ensure you are allowed to enter the building, your details
            ...
            <P>
              The information that is collected from cookies can include (but
              not excluded to):
            </P>
            <Ul>
              <Li>Browser type</Li>
      ...
      <BlogSection
        variant="dark"
        title="Do you want to read something more interesting?"
        posts={posts}
      />
