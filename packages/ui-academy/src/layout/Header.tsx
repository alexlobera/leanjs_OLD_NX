...
const HeaderSection = styled('header') <SectionProps>`
  ...
  @media (min-width: ${SCREEN_SM_MIN}) {
    min-height: ${({ minHeight }) => (minHeight ? minHeight : '650px')}; /*100vh*/
  }
`;
...
export const Header: FunctionComponent<HeaderProps> = ({
    ...
    links,
    info,
    textBgColor = 'rgba(0, 41, 56, 0.75)',
    callToAction = null,
}) => {
    const [bgImageUrl, setBgImageUrl] = React.useState(bgFixedImage?.base64 || bgImage)
