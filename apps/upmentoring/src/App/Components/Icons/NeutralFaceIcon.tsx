...
const NeutralFaceIcon: React.FunctionComponent<Props> = props => (
    ...
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 90 90">
      <switch>
        <g>
          ...
          <path d="M28.5,62.2h32.9c1.3,0,2.4-1.1,2.4-2.4v0c0-1.3-1.1-2.4-2.4-2.4H28.5c-1.3,0-2.4,1.1-2.4,2.4v0 C26.2,61.2,27.2,62.2,28.5,62.2z" />
